""" python mod divmod at hackerrank.com

Problem Statement

One of the built-in functions of Python is divmod,
which takes two arguments a and b and
returns a tuple containing the quotient of a/b (a//b) and
remainder a.
...
The first line is the integer division a//b (Remember
...
The first line contains the first integer, a, and the second
line contains the second integer, b.
