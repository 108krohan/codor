"""hackerrank tweets on hackerrank.com
"""

import re
p = re.compile(r"hackerrank", re.IGNORECASE)
...
Given a set of most popular tweets, your task
is to find out how many of those tweets has the string
hackerrank in it.
...
Print the total number of tweets that has hackerrank (case
insensitive) in it
