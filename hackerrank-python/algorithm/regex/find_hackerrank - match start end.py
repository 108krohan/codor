"""find hackerrank at hackerrank.com
"""
import re
pattern_2 = re.compile(r"(hackerrank)$") ##end
pattern_1 = re.compile(r"^(hackerrank)") ##start
##pattern_0 = re.compile(r"\b(hackerrank)\b")
testcases = int(raw_input())
for _ in range(testcases) :
    string = raw_input()
    if string == "hackerrank" :
        print 0
    elif re.search(pattern_2, string) :
        print 2
    elif re.match(pattern_1, string) :
        print 1
    else :
        print -1
...
every day and have scraped conversations from popular sites. Each
conversation fits in 1 line and there are N such conversations. Each
conversation has at most 1 word that says hackerrank (all in
lowercase). We would like you to help us figure out whether
a conversation:
...
From the second line onwards, each line contains a set of W
...
The third conversation has only one word, it starts and ends
with hackerrank and hence 0. 
The fourth conversation satisfies none of the above properties and
hence -1.
"""
