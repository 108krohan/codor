"""alien username at hackerrank.com
"""

##It has to begin with either an underscore '_' (ascii value 95) or
##a dot '.' (ascii value 46)
##It has to be immediately followed by one or more
##occurrences of digits numbered 0-9
...
import re
pattern = re.compile(r'^(\_|\.)\d+[a-z]*\_?$', re.IGNORECASE)
cases = int(raw_input())
